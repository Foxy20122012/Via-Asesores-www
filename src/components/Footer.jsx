...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-sky-700 via-sky-800 via-sky-600 to-sky-800  bg-blend-soft-light py-8 dark:bg-gray-900">
      ...
      <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">Via Asesores</a>. </span>
